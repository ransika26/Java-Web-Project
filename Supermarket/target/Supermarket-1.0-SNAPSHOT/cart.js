...
function proceedToCheckout(totalValue) {
    ...
    //  total price pass to "totalValue" and  stored in totalPrice variable.
  const totalPrice = parseFloat(totalValue.replace('Rs. ', '')); // Convert the string to a number
//const totalPrice =60.00;
